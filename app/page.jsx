          ...
          <div className="rounded-[2rem] bg-slate-950 p-8 text-white shadow-2xl">
            ...
            <div className="mt-6 grid gap-8 lg:grid-cols-[0.75fr_1.25fr] lg:items-center">
              ...
              <div className="rounded-3xl bg-white/10 p-6">
                <p className="text-2xl font-black leading-tight text-white">
                  Nearly half of intervention students finished proficient,
                  while many others demonstrated measurable growth, recovery
                  growth, or sustained upward movement from the previous year.
                </p>

                <p className="mt-4 leading-7 text-slate-300">
                  The strongest growth patterns consistently aligned with
                  structured accountability, reading stamina, vocabulary
                  support, small-group instruction, and improved independent
                  habits over time.
                </p>
              </div>
            </div>
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-3">
              ...
              <div className="rounded-3xl bg-white/5 p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-300">
                  Grade 8 students reaching proficiency or higher increased
                  sharply.
                </p>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-4 leading-7 text-slate-700">
                Students within targeted PM2 growth ranges frequently
                demonstrated proficiency attainment or measurable year-over-year
                growth through structured intervention support.
              </p>
            </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-4 text-2xl font-bold text-slate-900">200 of 206</p>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="space-y-5 text-lg leading-8 text-slate-700">
              <p>
                ...
                independence, and trust in their own thinking, and rigorous
                enough to move students beyond task completion into real
                thinking.
              </p>
              <p>
              ...
              <p>
                Just as importantly, students need classrooms where they feel
                safe enough to take academic risks, make mistakes publicly, and
                build confidence through consistent support and clear
